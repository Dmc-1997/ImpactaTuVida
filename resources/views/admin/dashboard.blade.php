...
{{-- <div class="row justify-content-end">
    <div class="col-lg-3 pb-2" align="right">
        <a class="nav-link btn-style" style="width: max-content;" href="{{ route('logoutv2') }}"onclick="event.preventDefault();
        ...
        <div class="row">
            ...
            <div class="col-lg-5 align-self-center">
                <ul class="style-chart-pie">
                    <li>
                        <strong style="font-size: 20px"> Tiempo promedio por usuario</strong>
                        <p id="pDebug" style="display:none";>{{json_encode($dashboard)}} | {{json_encode(get_defined_vars())}}</p>
                    </li>
                    <li>
                        <strong style="font-size: 20px">Total de tiempo consumido por los usuarios</strong>
                    </li>
                </ul>
            </div>
        </div>
